...
import AdPage from "./src/components/monetization/ad-pages/AdPage";
...
import PurchasePremium from "./src/components/purchase-premium";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/get-premium" element={<PurchasePremium />} />
